...
Containing the A12 Overview Engine package, migration tool, and interactive showcase applications for building data-driven overview interfaces with React.
...
To use the Overview Engine in your project:
...
- Compiling TypeScript source in `core` folder and others to JavaScript
