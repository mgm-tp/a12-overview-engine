...
[source,typescript,title="Setup the Overview Engine module"]
----
include::./assets/typescript/features/setup-module.ts[tags="main"]
----
...
[source,typescript,title="Setup the Overview Engine in non-modular way"]
----
include::./assets/typescript/features/setup-non-module.ts[tags="main"]
----
