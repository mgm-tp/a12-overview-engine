...
image::assets/images/filter-selector.png[title="Filter selector"]
...
image::assets/images/filter-option.png[title="Filter option"]
...
image::assets/images/filter-bar-with-option-view.png[title="Filter bar"]
...
image::assets/images/filter-option-string.png[title="String Filter Option"]
...
image::assets/images/filter-option-enumerated-string.png[title="String Filter Option as Multi-Select"]
...
image::assets/images/filter-option-number.png[title="Number Filter Option"]
...
image::assets/images/filter-option-boolean.png[title="Boolean Filter Option"]

=== Confirm

The confirm filter is similar to the boolean filter, but with three radio button options: *_Yes_* and *_Empty_*.

image::assets/images/filter-option-confirm.png[title="Confirm Filter Option"]
...
image::assets/images/filter-option-enumeration.png[title="Enumeration Filter Option"]
...
image::assets/images/filter-option-multi-select.png[title="Multi-Select Filter Option"]
...
image::assets/images/filter-option-date.png[title="Date Filter Option - By Date Range"]
...
image::assets/images/filter-option-date-by-month.png[title="Date Filter Option - By Month & Year Range"]
image::assets/images/filter-option-date-by-year.png[title="Date Filter Option - By Year Range"]
...
image::assets/images/filter-option-date-empty.png[title="Date Filter Option - Empty Values"]
...
image::assets/images/filter-option-time.png[title="Time Filter Option"]

=== DateTime

The date time filter is similar to the date filter, with the difference, that the user can specify also the time here.

image::assets/images/filter-option-date-time.png[title="Date Time Filter Option"]
...
This mechanism is related to the link:/docs/OVERALL/heterogeneity[heterogeneity] feature in *A12*, allowing filters to target fields across different models and submodels.
====
...
image::assets/images/preset-filters.png[title="Preset Filters with removable and non-removable filters"]
...
Remember to wrap these actions with `OverviewEngineActions.event` or `OverviewEngineActions.command` so the update is scoped to the correct activity. See link:./0300_overview_engine_actions.adoc#dispatch-engine-action[Dispatch an Engine Action] for the dispatching pattern.
