...
[source,typescript,options="nowrap",title="Create a component with custom field formatter"]
----
include::./assets/typescript/features/custom-field-format.tsx[tags="custom-reference-cell-example"]
----

[source,typescript,options="nowrap",title="Override the corresponding component in component map"]
----
include::./assets/typescript/features/custom-field-format.tsx[tags="custom-field-format-example"]
----
