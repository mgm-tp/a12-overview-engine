...
In case the project has accessibility requirements, link:./assets/generated/typedoc/interfaces/view_overview-engine.OverviewEngine.CommonProps.html#accessibilityconfigurations[`accessibilityConfigurations`] property of `OverviewEngine` could be used to set accessibility-related features, including.
