...
Overview Engine supports registering the handlers by passing a callback into link:./assets/generated/typedoc/interfaces/view_api.OverviewEngineApi.EventHandlers.html#oneventbuttonclick-1[onEventButtonClick] of `eventHandlers` prop.
