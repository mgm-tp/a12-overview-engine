...
[source,typescript,options="nowrap",title="RowStyles interface"]
----
include::./assets/typescript/features/row-style-getter.tsx[tags="row-styles-interface"]
----
...
----
include::./assets/typescript/features/row-style-getter.tsx[tags="row-style-getter-example"]
----
