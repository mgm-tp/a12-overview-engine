...
[source,bash]
----
npx @com.mgmtp.a12.overviewengine/overviewengine-codemod@latest <recipe-id> <tsconfig-path>
----

.Example: Running a specific recipe
[source,bash]
----
npx @com.mgmtp.a12.overviewengine/overviewengine-codemod@latest rename-deprecated-props ./tsconfig.json
----
...
[source,bash]
----
npx @com.mgmtp.a12.overviewengine/overviewengine-codemod@latest <target-version> <tsconfig-path>
----
...
[source,bash]
----
npx @com.mgmtp.a12.overviewengine/overviewengine-codemod@latest --interactive
----
