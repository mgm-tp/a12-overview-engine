...
export const NumberInput: React.FC<NumberInput.Props> = (props) => {
	const [value, setValue] = useValue<number | null>(props.path);
	const onValueSubmit = React.useCallback(
		(value: string | undefined) => setValue(value === undefined ? null : parseInt(value)),
		[setValue]
	);
