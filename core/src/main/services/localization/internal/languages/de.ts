...
export const de: typeof RESOURCE_KEYS = {
	"overviewEngine": {
		...
		"multiSelection": {
			...
			"clearConfirmation": {
				"title": "Warnung",
				"message": "Durch Filtern, Suchen oder Einklappen des Mehrfachauswahlfelds wird die Auswahl der Dokumente zurückgesetzt. Sind Sie sicher, dass Sie fortfahren möchten?",
				"ok": "Auswahl Löschen",
				"cancel": "Abbrechen"
			},
