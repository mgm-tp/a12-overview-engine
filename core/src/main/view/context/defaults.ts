...
export const defaultDocumentModel: DocumentModel = {
	get header(): DocumentModel["header"] {
		throw new Error(DEFAULT_ERROR_MESSAGE);
	},
	get content(): DocumentModel["content"] {
		throw new Error(DEFAULT_ERROR_MESSAGE);
	}
};

/** @internal */
export const defaultOverviewModel: OverviewModel = {
	get header(): OverviewModel["header"] {
		throw new Error(DEFAULT_ERROR_MESSAGE);
	},
	get content(): OverviewModel["content"] {
		throw new Error(DEFAULT_ERROR_MESSAGE);
	}
};
