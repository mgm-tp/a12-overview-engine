...
import { BufferedInput, HTMLInputAdapter, TextLineStateless } from "@com.mgmtp.a12.widgets/widgets-core";
...
const DateInput = BufferedInput(HTMLInputAdapter(TextLineStateless));
