...
/** @experimental until 40.0.0 - API may change without semver guarantees. */
export const ConfirmFilterSetting: FC<ConfirmFilterSettingProps> = memo(function ConfirmFilterSetting({ state }) {
	const { empty } = state.options;
	const onFilterOptionsChange = useDispatchFilterOptions<ConfirmFilterState>(state.model.id);
