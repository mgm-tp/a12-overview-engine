...
import type { DateFilterState } from "../../../../../store/index.js";
...
/** @experimental until 40.0.0 - API may change without semver guarantees. */
export const DateFilterSetting: FC<DateFilterSettingProps> = memo(function DateFilterSetting({ state }) {
	...
	const availablePeriods = useAvailableListPeriods<OverviewModel.NewFilter.Date.PeriodOption>(
				...
				<>
					...
					{availablePeriods.length > 1 && (
						<FilterSettingSection label={localizedResource(t.period)}>
							<RadioSetting<OverviewModel.NewFilter.Date.PeriodOption>
								name="date-filter-period"
