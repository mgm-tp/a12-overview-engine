...
/** @experimental until 40.0.0 - API may change without semver guarantees. */
export const BooleanFilterSetting: FC<BooleanFilterSettingProps> = memo(function BooleanFilterSetting({ state }) {
	const { empty } = state.options;
	const onFilterOptionsChange = useDispatchFilterOptions<BooleanFilterState>(state.model.id);
