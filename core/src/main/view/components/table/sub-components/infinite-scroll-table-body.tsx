...
/** @internal */
export const InfiniteScrollTableBody: React.ComponentType<InfiniteScrollTableBody.Props> = React.memo(
	function InfiniteScrollTableBody(props) {
		...
		return <>{DefaultTableComponentRenderers.infiniteScrollBodyRenderer(props)}</>;
	}
);
